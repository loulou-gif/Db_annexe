    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('baptism_water', models.CharField(choices=[('oui', 'oui'), ('non', 'non')], default=None, max_length=3)),
                ('date', models.DateField(default=None, null=True)),
                ('baptism_spirit', models.CharField(choices=[('oui', 'oui'), ('non', 'non')], default=None, max_length=3)),
                ('community', models.CharField(choices=[('ORDRE ET ACCEUIL', 'ORDRE ET ACCEUIL'), ('COMMITE SOCIAL', 'COMMITE SOCIAL')], max_length=16)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('filieres', models.CharField(max_length=36)),
                ('person', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='formulaires.person')),
            ],
        ),
        migrations.CreateModel(
